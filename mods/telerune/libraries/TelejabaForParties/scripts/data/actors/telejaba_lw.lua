local actor, super = Class(Actor, "telejaba_lw")
...
function actor:init()
    ...
    self.color = {120, 29, 79}

    -- Path to this actor's sprites (defaults to "")
    --self.path = "party/telejaba/light"
    self.path = "party/telejaba/dark"
    ...
    self.portrait_path = "face/telejaba_lw"
    ...
    self.animations = {
     ...
     self.offsets = {
         ...
         ["walk_unhappy/down"] = {0, 6},
         ["walk_unhappy/right"] = {0, 6},
         ["walk_unhappy/left"] = {0, 6},
         ["walk_unhappy/up"] = {0, 6},
